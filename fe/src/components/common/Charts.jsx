		...
		<div className="space-y-6 mb-8">
			...
			<div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-5 shadow-sm">
				...
				<p className="text-lg text-gray-800 font-medium">
					Kamu belajar selama <span className="font-bold">{totalHoursThisWeek} jam</span> minggu
					ini, rata-rata <span className="font-bold">{avgHoursPerDay.toFixed(1)} jam/hari</span>.
					Targetmu tercapai selama{" "}
					<span className="font-bold text-blue-600">{goalAchievement}</span> hari!
				</p>
				<p className="text-sm text-green-600 mt-2">Naik +2.5 jam dibanding minggu lalu 🚀</p>
			</div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<div className="bg-gradient-to-br from-indigo-50 via-white to-blue-50 rounded-xl shadow-md p-6 border border-gray-100">
					...
					<p className="text-sm text-gray-500 mb-6">Performa nilai rata-rata per materi</p>
