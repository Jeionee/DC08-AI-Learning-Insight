    ...
    return (<div className=" flex-1 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <StatsCard
                ...
                color="blue"
                description={`Total modul selesai: ${data.progress.completedModules || 5}/${data.progress.totalModules || 8}`}
            />
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div className="flex space-x-2">
                    {Object.entries(learningStyles).map(([key, style]) => (<span
                        key={key}
                        className={`px-3 py-1 rounded-full text-xs font-medium border ${key === student.image_path ? style.color : "bg-gray-100 text-gray-600 border-gray-200"}`}
                    >
								{style.name.split(" ")[0]}
							</span>))}
                </div>
