                        ...
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h3 className="font-semibold text-gray-900 text-lg flex items-center gap-2">
                                    ...
                                    {module.progress === 100 && (
                                        <span
                                            className="text-green-600 text-sm bg-green-50 px-2 py-0.5 rounded-full">Selesai</span>
                                    )}
                                </h3>
                                <p className="text-gray-600 text-sm mt-1">Lanjutkan belajar untuk meningkatkan
                                    nilaimu</p>
                            </div>
                            <div className="text-right">
                                <span className="text-blue-600 font-semibold">{module.progress}% Selesai</span>
                                <div className="text-sm text-gray-500 mt-1">
                                    {module.assessments.filter(a => a.score !== null).length} dari {module.assessments.length} tugas
                                    selesai
                                </div>
                            </div>
                        </div>
