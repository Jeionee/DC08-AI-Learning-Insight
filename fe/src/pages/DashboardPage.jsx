...
import { Bell, Search, Calendar, ChevronDown, Filter, TrendingUp, Clock, BookOpen } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-6">
            <div>
              ...
              <p className="text-indigo-200 text-base max-w-lg">
                Siap melanjutkan progres belajarmu? Mari kita selesaikan target hari ini dengan semangat!
              </p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-[2rem] p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8">
                ...
                <div className="flex items-center gap-2 mt-4 sm:mt-0">
                  <button className="flex items-center gap-2 px-4 py-2 bg-slate-50 text-slate-600 text-sm font-medium rounded-lg hover:bg-slate-100 transition">
                    <Filter size={16} />
                    Filter
                  </button>
                  <select className="bg-slate-50 border-none text-sm font-semibold text-slate-700 rounded-lg px-3 py-2 cursor-pointer hover:bg-slate-100 focus:ring-0">
          ...
          <div className="xl:col-span-1 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-3xl p-5 shadow-lg shadow-indigo-100/50 border border-slate-100 flex flex-col items-center justify-center text-center group hover:-translate-y-1 transition-transform duration-300">
                ...
                <p className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-1">Time Spent</p>
              ...
              <div className="bg-white rounded-3xl p-5 shadow-lg shadow-indigo-100/50 border border-slate-100 flex flex-col items-center justify-center text-center group hover:-translate-y-1 transition-transform duration-300">
                ...
                <p className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-1">Modules</p>
                <div className="flex items-baseline gap-1">
