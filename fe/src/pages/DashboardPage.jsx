...
const Dashboard = ({ data }) => {
  ...
  useEffect(() => {
    async function loadDaily() {
      const d = await getDailyProgress();
      setDailyProgress({
  ...
  useEffect(() => {
    async function loadProgress() {
      ...
      setProgress(data.daily_progress || []);
    }
    loadProgress();
  }, []);
    ...
    <div className="flex-1 pr-8 py-1 pl-0 border-0">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 my-3">
          Selamat datang kembali, <b>{student.name}</b> ! Mari lanjutkan
          pembelajaranmu.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        {/* LEARNING STYLE */}
        <LearningStyle learning_style={student.learning_style} />
      </div>
