...
const ALL_MODULES_DATA = [
  {
    ...
    description: "Pelajari dasar-dasar HTML dan CSS.",
    category: "Frontend",
    progress: 85,
  },
  {
    ...
    description: "Pelajari sintaks dasar JavaScript.",
    category: "Logic",
    progress: 70,
  },
  {
    ...
    description: "Belajar membuat website responsive.",
    category: "Design",
    progress: 45,
  },
  {
    id: 4,
    title: "React Basics",
    description: "Pelajari dasar React.",
    category: "Frontend",
    progress: 60,
  },
  {
    ...
    description: "Pelajari dasar backend dengan Node.js.",
    category: "Backend",
    progress: 0,
  },
  {
    ...
    description: "Pelajari Git dan GitHub.",
    category: "Tools",
    progress: 0,
  },
];
...
export default function ModulePage() {
  ...
  useEffect(() => {
    let results = ALL_MODULES_DATA.filter(
      (module) =>
            ...
            <div className="relative z-10 mt-auto">
              <div className="mb-6">
                <div className="flex justify-between text-xs font-bold mb-2">
                  <span
                    className={module.progress > 0 ? "text-slate-400" : "text-slate-300"}
                  >
                    {module.progress > 0 ? "Progress" : "Belum Dimulai"}
                  </span>
                  <span
                    className={module.progress > 0 ? "text-indigo-600" : "text-slate-300"}
                  >
                    {module.progress}%
                  </span>
                </div>
              ...
              >
                <Zap
                  size={16}
                  className={module.progress > 0 ? "fill-current" : ""}
                />
