        ...
        <div className="hidden md:flex w-1/2 lg:w-7/12 bg-indigo-900 relative items-center justify-center p-12 overflow-hidden">
          ...
          <div className="relative z-10 text-white max-w-md">
            ...
            <p className="text-indigo-100 text-lg leading-relaxed mb-8">
              Bergabung dengan ribuan siswa lainnya. Akses materi eksklusif, quiz interaktif, dan sertifikat kelulusan yang diakui industri.
            </p>
            
            {/* Testimonial Mini Card */}
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 flex items-start gap-4">
              <div className="w-10 h-10 rounded-full bg-yellow-400 flex items-center justify-center text-yellow-900 font-bold">A</div>
              <div>
                <p className="text-sm italic text-white/90 mb-2">"Platform ini mengubah cara saya belajar. Materinya sangat terstruktur dan mudah dipahami!"</p>
                <p className="text-xs font-bold text-white uppercase tracking-wider">Andi Saputra - Alumni</p>
              </div>
            </div>
          </div>
