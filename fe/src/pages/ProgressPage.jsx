					...
					<div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
						<div>
							...
							<p className="text-slate-500 text-lg mt-2 max-w-xl leading-relaxed">
								Pantau terus perkembangan skillmu. Setiap langkah kecil membawamu lebih dekat ke
								tujuan! 🚀
							</p>
						</div>
					</div>
	...
	return (
		...
		>
			...
			<div className="relative z-10">
				...
				<div>
					<p className={`${theme.text} text-xs font-bold uppercase tracking-wider mb-1 opacity-80`}>
						{title}
					</p>
